...
public class ToucanSymbolTableException : Exception
{
    public string ToucanSymbolTableExceptionMessage { get; }

    #region Public

    public ToucanSymbolTableException( string message ) : base( message )
    {
        ToucanSymbolTableExceptionMessage = message;
    }
...
public class SymbolTableBuilder : AstVisitor < object >, IAstVisitor
{
    ...
    public override object Visit( ClassDeclarationBaseNode node )
    {
        ...
        ToucanClassType classType = new ToucanClassType( node.ClassId.Id );
                                                                               ...
                                                                               Variables )
        {
            ...
            if ( memberDeclarationContext.VarId != null )
            {
                ...
                fieldSymbol.Type = new ToucanClassType( "Object" );
                     ...
                     ClassInstances )
        {
            ...
            if ( memberDeclarationContext.InstanceId != null )
            {
                ...
                fieldSymbol.Type = new ToucanClassType( memberDeclarationContext.ClassName.Id );
                fieldSymbol.DefinitionBaseNode = memberDeclarationContext;
                m_SymbolTable.CurrentScope.define( fieldSymbol );
            }
        }
    ...
    public override object Visit( FunctionDeclarationBaseNode node )
    {
        ...
        ToucanClassType functionType = new ToucanClassType( "Object" );
    ...
    public override object Visit( LocalVariableDeclarationBaseNode node )
    {
        ...
        variableSymbol.Type = new ToucanClassType( "Object" );
    ...
    public override object Visit( ClassInstanceDeclarationBaseNode node )
    {
        ...
        ToucanClassType classType = new ToucanClassType( node.ClassName.Id );
