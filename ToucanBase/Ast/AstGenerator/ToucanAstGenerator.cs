...
public class ToucanAstGeneratorException : ApplicationException
{
    public string AstGeneratorExceptionMessage { get; }

    #region Public

    public ToucanAstGeneratorException( string message ) : base( message )
    {
...
public class ToucanAstGenerator : ToucanParserBaseVisitor < AstBaseNode >
{
    ...
    public ProgramBaseNode CreateAst( ToucanParser.ProgramContext programContext )
    {
    ...
    public override AstBaseNode VisitAbstractModifier( ToucanParser.AbstractModifierContext context )
    {
        return base.VisitAbstractModifier( context );
    }

    public override AstBaseNode VisitAdditive( ToucanParser.AdditiveContext context )
    {
        if ( context.multiplicative().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.MultiplicativeContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                {
                    if ( context.GetChild( counter ) is ToucanParser.MultiplicativeContext rhsContext )
                    {
    ...
    public override AstBaseNode VisitArgumentExpression( ToucanParser.ArgumentExpressionContext context )
    {
        return base.VisitArgumentExpression( context );
    }

    public override AstBaseNode VisitArguments( ToucanParser.ArgumentsContext context )
    {
        ...
        foreach ( ToucanParser.ArgumentExpressionContext expressionContext in context.argumentExpression() )
        {
    ...
    public override AstBaseNode VisitArrayExpression( ToucanParser.ArrayExpressionContext context )
    {
        ...
        if ( context.expression() != null )
        {
            ...
            foreach ( ToucanParser.ExpressionContext expression in context.expression() )
            {
    ...
    public override AstBaseNode VisitAssignment( ToucanParser.AssignmentContext context )
    {
    ...
    public override AstBaseNode VisitBitwiseAnd( ToucanParser.BitwiseAndContext context )
    {
        if ( context.equality().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.EqualityContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                {
                    if ( context.GetChild( counter ) is ToucanParser.EqualityContext rhsContext )
                    {
                        currentBinaryOperationBaseNode.RightOperand =
    ...
    public override AstBaseNode VisitBitwiseOr( ToucanParser.BitwiseOrContext context )
    {
        if ( context.bitwiseXor().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.BitwiseXorContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                else if ( context.GetChild( counter ) is ToucanParser.BitwiseXorContext rhsContext )
                {
    ...
    public override AstBaseNode VisitBitwiseXor( ToucanParser.BitwiseXorContext context )
    {
        if ( context.bitwiseAnd().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.BitwiseAndContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                else if ( context.GetChild( counter ) is ToucanParser.BitwiseAndContext rhsContext )
                {
                    currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                    currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitBlock( ToucanParser.BlockContext context )
    {
        ...
        foreach ( ToucanParser.DeclarationContext declarationContext in context.declaration() )
        {
    ...
    public override AstBaseNode VisitBreakStatement( ToucanParser.BreakStatementContext context )
    {
    ...
    public override AstBaseNode VisitCall( ToucanParser.CallContext context )
    {
        if ( context.ChildCount > 0 )
        {
            ...
            if ( tree is ToucanParser.PrimaryContext )
            {
                ...
                while ( childCounter < context.ChildCount )
                {
                    ...
                    else if ( tree is ToucanParser.CallArgumentsContext callArgumentsContext )
                    {
                        ...
                        if ( callArgumentsContext.arguments() != null )
                        {
                                 ...
                                 null )
                            {
                                ...
                                foreach ( ToucanParser.ArgumentExpressionContext expressionContext in
                                         callArgumentsContext.
                                             arguments().
                                             argumentExpression() )
                                {
                    ...
                    else if ( tree is ToucanParser.ElementAccessContext elementAccess )
                    {
                        if ( currentIdentifier != null )
                        {
                            currentIdentifier.ElementAccess = new List < CallElementEntry >();

                            foreach ( ToucanParser.ElementIdentifierContext elementIdentifierContext in elementAccess.
                                         elementIdentifier() )
                            {
    ...
    public override AstBaseNode VisitCallArguments( ToucanParser.CallArgumentsContext context )
    {
        return base.VisitCallArguments( context );
    }

    public override AstBaseNode VisitClassDeclaration( ToucanParser.ClassDeclarationContext context )
    {
    ...
    public override AstBaseNode VisitClassInstanceDeclaration( ToucanParser.ClassInstanceDeclarationContext context )
    {
        ...
        ToucanParser.InitializerExpressionContext initializerExpression = context.initializerExpression();

        if ( initializerExpression != null )
        {
            classInstanceDeclarationBaseNode.Initializers = new List < MemberInitializationNode >();

            foreach ( ToucanParser.MemberInitializationContext initialization in initializerExpression.
    ...
    public override AstBaseNode VisitDeclaration( ToucanParser.DeclarationContext context )
    {
    ...
    public override AstBaseNode VisitDictionaryExpression( ToucanParser.DictionaryExpressionContext context )
    {
        ...
        if ( context.elementInitialization() != null )
        {
            ...
            foreach ( ToucanParser.ElementInitializationContext initialization in context.elementInitialization() )
            {
    ...
    public override AstBaseNode VisitElementAccess( ToucanParser.ElementAccessContext context )
    {
        return base.VisitElementAccess( context );
    }

    public override AstBaseNode VisitElementIdentifier( ToucanParser.ElementIdentifierContext context )
    {
        return base.VisitElementIdentifier( context );
    }

    public override AstBaseNode VisitEquality( ToucanParser.EqualityContext context )
    {
        if ( context.relational().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.RelationalContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                {
                    if ( context.GetChild( counter ) is ToucanParser.RelationalContext rhsContext )
                    {
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitExpression( ToucanParser.ExpressionContext context )
    {
    ...
    public override AstBaseNode VisitExprStatement( ToucanParser.ExprStatementContext context )
    {
    ...
    public override AstBaseNode VisitExternalFunctionDeclaration(
        ToucanParser.ExternalFunctionDeclarationContext context )
    {
    ...
    public override AstBaseNode VisitForInitializer( ToucanParser.ForInitializerContext context )
    {
        ForInitializerBaseNode forInitializerBaseNode = new ForInitializerBaseNode();

        ToucanParser.ExpressionContext[] expressions = context.expression();
        ...
        if ( expressions != null && expressions.Length > 0 )
        {
            ...
            foreach ( ToucanParser.ExpressionContext expression in expressions )
            {
                forInitializerBaseNode.Expressions[i++] = ( ExpressionBaseNode ) VisitExpression( expression );
            }
        }

        ToucanParser.LocalVarInitializerContext localVarInitializer = context.localVarInitializer();
    ...
    public override AstBaseNode VisitForStatement( ToucanParser.ForStatementContext context )
    {
        ...
        ToucanParser.ForInitializerContext initializer = context.forInitializer();
        ...
        ToucanParser.ForIteratorContext iterators = context.forIterator();

        if ( iterators != null )
        {
            ToucanParser.ExpressionContext[] expressions = iterators.expression();

            forStatementBaseNode.Iterators = new ExpressionBaseNode[expressions.Length];
            int i = 0;

            foreach ( ToucanParser.ExpressionContext iterator in expressions )
            {
    ...
    public override AstBaseNode VisitFunctionDeclaration( ToucanParser.FunctionDeclarationContext context )
    {
        FunctionDeclarationBaseNode functionDeclarationBaseNode = new FunctionDeclarationBaseNode();
        functionDeclarationBaseNode.FunctionId = new Identifier();
    ...
    public override AstBaseNode VisitIfStatement( ToucanParser.IfStatementContext context )
    {
    ...
    public override AstBaseNode VisitImportDirective( ToucanParser.ImportDirectiveContext context )
    {
        return base.VisitImportDirective( context );
    }

    public override AstBaseNode VisitInheritance( ToucanParser.InheritanceContext context )
    {
        return base.VisitInheritance( context );
    }

    public override AstBaseNode VisitLocalVarDeclaration( ToucanParser.LocalVarDeclarationContext context )
    {
    ...
    public override AstBaseNode VisitLocalVarInitializer( ToucanParser.LocalVarInitializerContext context )
    {
        ...
        ToucanParser.LocalVarDeclarationContext[] localVarDeclarations = context.localVarDeclaration();

        if ( localVarDeclarations != null )
        {
            foreach ( ToucanParser.LocalVarDeclarationContext localVarDeclarationContext in
    ...
    public override AstBaseNode VisitLogicAnd( ToucanParser.LogicAndContext context )
    {
        if ( context.bitwiseOr().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.BitwiseOrContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                else if ( context.GetChild( counter ) is ToucanParser.BitwiseOrContext rhsContext )
                {
                    currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                    currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitLogicOr( ToucanParser.LogicOrContext context )
    {
        if ( context.logicAnd().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.LogicAndContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                else if ( context.GetChild( counter ) is ToucanParser.LogicAndContext rhsContext )
                {
                    currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                    currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitMemberInitialization( ToucanParser.MemberInitializationContext context )
    {
    ...
    public override AstBaseNode VisitModule( ToucanParser.ModuleContext context )
    {
        ...
        for ( int i = 0; i < context.importDirective().Length; i++ )
        {
            ...
            {
                throw new ToucanAstGeneratorException(
    ...
    public override AstBaseNode VisitMultiplicative( ToucanParser.MultiplicativeContext context )
    {
        if ( context.unary().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.UnaryContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                {
                    if ( context.GetChild( counter ) is ToucanParser.UnaryContext rhsContext )
                    {
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitParameters( ToucanParser.ParametersContext context )
    {
        ...
        foreach ( ToucanParser.ParametersIdentifierContext parametersIdentifier in context.parametersIdentifier() )
        {
    ...
    public override AstBaseNode VisitPrimary( ToucanParser.PrimaryContext context )
    {
        PrimaryBaseNode primaryBaseNode = new PrimaryBaseNode();
        ...
        if ( context.@string() != null )
        {
            ...
            foreach ( ToucanParser.StringPartContext stringContent in context.@string().stringPart() )
            {
    ...
    public override AstBaseNode VisitProgram( ToucanParser.ProgramContext context )
    {
        ...
        foreach ( ToucanParser.ModuleContext declarationContext in context.module() )
        {
    ...
    public override AstBaseNode VisitRelational( ToucanParser.RelationalContext context )
    {
        if ( context.shift().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.ShiftContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                {
                    if ( context.GetChild( counter ) is ToucanParser.ShiftContext rhsContext )
                    {
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitReturnStatement( ToucanParser.ReturnStatementContext context )
    {
    ...
    public override AstBaseNode VisitShift( ToucanParser.ShiftContext context )
    {
        if ( context.additive().Length > 1 )
        {
            ...
            if ( context.GetChild( counter ) is ToucanParser.AdditiveContext lhsContext )
            {
            ...
            while ( counter < context.ChildCount )
            {
                ...
                {
                    if ( context.GetChild( counter ) is ToucanParser.AdditiveContext rhsContext )
                    {
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberStart = rhsContext.Start.Line;
                        currentBinaryOperationBaseNode.DebugInfoAstNode.LineNumberEnd = rhsContext.Stop.Line;
    ...
    public override AstBaseNode VisitStatement( ToucanParser.StatementContext context )
    {
    ...
    /// <returns></returns>
    public override AstBaseNode VisitStatements( ToucanParser.StatementsContext context )
    {
        ...
        foreach ( ToucanParser.DeclarationContext declaration in context.declaration() )
        {
    ...
    public override AstBaseNode VisitStructDeclaration( ToucanParser.StructDeclarationContext context )
    {
    ...
    public override AstBaseNode VisitSyncBlock( ToucanParser.SyncBlockContext context )
    {
    ...
    public override AstBaseNode VisitTernary( ToucanParser.TernaryContext context )
    {
    ...
    public override AstBaseNode VisitUnary( ToucanParser.UnaryContext context )
    {
    ...
    public override AstBaseNode VisitUsingStatement( ToucanParser.UsingStatementContext context )
    {
    ...
    public override AstBaseNode VisitVariableDeclaration( ToucanParser.VariableDeclarationContext context )
    {
    ...
    public override AstBaseNode VisitWhileStatement( ToucanParser.WhileStatementContext context )
    {
