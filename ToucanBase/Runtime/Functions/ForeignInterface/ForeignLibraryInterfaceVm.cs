...
public class ForeignLibraryInterfaceVm : IToucanVmCallable
{
        ...
        if ( arguments.Length > 0 )
        {
                 ...
                 arguments[0].ObjectData is FastMemorySpace fliObject )
            {
                ...
                if ( !string.IsNullOrEmpty( typeString ) )
                {
                    ...
                    DynamicToucanVariable returnClassBool = fliObject.Get( "ReturnClass" );
                    ...
                    DynamicToucanVariable methodString = fliObject.Get( "Method" );
                         ...
                         !string.IsNullOrEmpty( methodString.StringData ) )
                    {
                        ...
                        {
                            foreach ( DynamicToucanVariable instanceProperty in instanceTypes.Properties )
                            {
                        ...
                        if ( method != null && method.IsStatic )
                        {
                            if ( fliObject.Get( "Arguments" ).ObjectData is FastMemorySpace instance )
                            {
                                ...
                                foreach ( DynamicToucanVariable instanceProperty in instance.Properties )
                                {
                        ...
                        if ( method != null && !method.IsStatic )
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    foreach ( DynamicToucanVariable instanceProperty in
                                ...
                                if ( fliObject.Get( "ConstructorArguments" ).ObjectData is FastMemorySpace
                                    constructorInstance )
                                {
                                    foreach ( DynamicToucanVariable instanceProperty in constructorInstance.
                                                 Properties )
                                    {
...

                        {
                            ...
                            if ( fliObject.Get( "ConstructorArguments" ).ObjectData is FastMemorySpace
                                constructorInstanceTypes )
                            {
                                foreach ( DynamicToucanVariable instanceProperty in constructorInstanceTypes.
                                             Properties )
                                {
                                    constructorArgTypes.Add( instanceProperty.GetType() );
                                }
...

                    {
                        ...
                        {
                            foreach ( KeyValuePair < string, DynamicToucanVariable >
