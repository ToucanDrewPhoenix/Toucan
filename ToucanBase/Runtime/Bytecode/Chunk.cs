...
{
    public ToucanVmOpCodes OpCode;
    public int[] OpCodeData;

    #region Public

    public ByteCode( ToucanVmOpCodes opCode )
    {
        OpCode = opCode;
    }

    public ByteCode( ToucanVmOpCodes opCode, int opCodeData )
    {
        OpCode = opCode;
        OpCodeData = new[] { opCodeData };
    }

    public ByteCode( ToucanVmOpCodes opCode, int opCodeData1, int opCodeData2 )
    {
        OpCode = opCode;
        OpCodeData = new[] { opCodeData1, opCodeData2 };
    }

    public ByteCode( ToucanVmOpCodes opCode, int opCodeData1, int opCodeData2, int opCodeData3 )
    {
        OpCode = opCode;
        OpCodeData = new[] { opCodeData1, opCodeData2, opCodeData3 };
    }

    public ByteCode( ToucanVmOpCodes opCode, int opCodeData1, int opCodeData2, int opCodeData3, int opCodeData4 )
    {
        OpCode = opCode;
