...
public static class ChunkHelper
{
    ...
    public static int WriteToChunk( this Chunk chunk, ToucanVmOpCodes code, int line )
    {
    ...
    public static int WriteToChunk( this Chunk chunk, ToucanVmOpCodes code, ConstantValue constant, int line )
    {
