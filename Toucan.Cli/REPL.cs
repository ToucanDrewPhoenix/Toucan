...
public class REPL
{
    ...
    {
        Console.WriteLine( "Starting Toucan interactive command prompt...\r\n" );
        ...
        ToucanVm.RegisterSystemModuleCallables();

        ToucanProgram program = null;
                ...
                if ( bufferString.Length > 0 )
                {
                    ...
                    else if ( running )
                    {
                        ...
                        try
                        {
                            ...
                            ToucanVmInterpretResult result = ToucanVm.Interpret( program );
                        }
                        catch ( Exception e )
                        {
